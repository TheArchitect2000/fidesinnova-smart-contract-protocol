...
contract ZKPStorage {
     ...
     * @param nodeId The ID of the node associated with the ZKP.
     * @param zkpPayload The ZKP data values and commitmnent ID.
     * @param dataPayload The IoT device generated data.
     * @param timestamp The timestamp when the ZKP was stored.
     */

    struct ZKP {
        string  nodeId;            // nodeId
        string  deviceId;          // deviceId
        bytes   zkpPayload;        // The zkp data. Note, it contains the commitment ID as well
